...
<style scoped>
/* 您在 main.css 中的 .tool-btn 样式
  将自动应用于 NuxtLink，但我们需要移除 NuxtLink 的
  默认下划线并确保颜色正确。
*/
.tool-btn {
  text-decoration: none;
  color: white; /* 确保图标和文字是白色的 */
}

/* 确保 NuxtLink 激活时(如果需要)或悬停时样式正确 */
.tool-btn:hover {
